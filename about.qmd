...
This is an experimental site created and maintained by [Rob Proulx](https://www.ndsu.edu/agriculture/ag-home/directory/rob-proulx), Ag Technology and Grain Systems Specialist with North Dakota State University Extension. Delta T forecast maps are derived from National Weather Service hourly forecasts and are not an official NWS forecast product.
...
![Summary of herbicide spraying recommendations in response to Delta T values. Adapted from the NDSU Weed Management Guide online supplement.](bin/delta-t-map-legend.png){fig-alt="Vertical Delta T Management Scale from North Dakota State University. A color‑coded bar on the left ranges from yellow at the top, to green in the middle, to yellow then red at the bottom and is labeled with Delta T values. From 0 to about 4 (yellow zone), the label reads ‘Caution.’ From about 4 to 14 (green zone), the label reads ‘Preferred.’ From about 14 to 18 (yellow zone), the label reads ‘Caution.’ From 18 to 22 and higher (red zone), text states ‘Unsuitable for fine (F) or medium (M) droplet sizes’ and ‘Unsuitable for all droplet sizes.’ The top right includes the NDSU North Dakota State University logo with the heading ‘Delta T Management Scale.’"}
...
Please direct any questions or comments to [Rob Proulx](mailto:rob.proulx@ndsu.edu?subject=ND%20Delta%20T%20Website), NDSU Extension Ag Technology and Grain Systems Specialist.
